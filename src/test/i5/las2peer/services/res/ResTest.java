...
public class ResTest {
  ...
  public void testSecondTestCase2() {
    ...
    try {
      ClientResponse result = c.sendRequest("GET", mainPath + "/reqthree", "");
  ...
  public void testFirstTestCase2() {
    ...
    try {
      ClientResponse result = c.sendRequest("GET", mainPath + "/reqone", "");
    ...
    try {
      ClientResponse result = c.sendRequest("GET", mainPath + "/reqtwo", "");
